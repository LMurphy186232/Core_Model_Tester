...
// Tests fifth normal processing run. WriteMastingDisperseAutocorrelationXMLFile5() does setup. This tests
...
/////////////////////////////////////////////////////////////////////////////
/*TEST(MastingDisperseAutocorrelation, NormalProcessingRun5) {
  clSimManager * p_oSimManager = new clSimManager( 7, 1, "" );
  int iNumRuns = 100,
 *p_iCounts = new int[iNumRuns],
  ...
  try {
    ...
    for (i = 0; i < iNumRuns; i++) {
      p_oSimManager->ReadFile(WriteMastingDisperseAutocorrelationXMLFile5(i));
...
/////////////////////////////////////////////////////////////////////////////
// WriteMastingDisperseAutocorrelationXMLFile5()
/////////////////////////////////////////////////////////////////////////////
