...
const char* WriteGeneralizedHarvestRegimeXMLFile1() {
  ...
  oOut << "<GeneralizedHarvestRegime1>"
       ...
       << "</di_genHarvLogCutProbMu>"
       << "<di_genHarvLogCutProbA>"
       << "<di_ghlcpaaVal species=\"Species_1\">21.2954</di_ghlcpaaVal>"
       << "<di_ghlcpaaVal species=\"Species_2\">21.2954</di_ghlcpaaVal>"
       << "</di_genHarvLogCutProbA>"
       << "<di_genHarvLogCutProbB>"
       << "<di_ghlcpbVal species=\"Species_1\">0.01202805</di_ghlcpbVal>"
       << "<di_ghlcpbVal species=\"Species_2\">0.01202805</di_ghlcpbVal>"
       << "</di_genHarvLogCutProbB>"
       << "<di_genHarvLogCutProbC>"
       << "<di_ghlcpcVal species=\"Species_1\">15.20595</di_ghlcpcVal>"
       << "<di_ghlcpcVal species=\"Species_2\">15.20595</di_ghlcpcVal>"
       << "</di_genHarvLogCutProbC>"
...
const char* WriteGeneralizedHarvestRegimeXMLFile4() {
  ...
  oOut << "<GeneralizedHarvestRegime1>"
       ...
       << "</di_genHarvLogCutProbMu>"
       << "<di_genHarvLogCutProbA>"
       << "<di_ghlcpaaVal species=\"Species_1\">65.51862</di_ghlcpaaVal>"
       << "<di_ghlcpaaVal species=\"Species_2\">65.51862</di_ghlcpaaVal>"
       << "</di_genHarvLogCutProbA>"
       << "<di_genHarvLogCutProbB>"
       << "<di_ghlcpbVal species=\"Species_1\">0.2821873</di_ghlcpbVal>"
       << "<di_ghlcpbVal species=\"Species_2\">0.2821873</di_ghlcpbVal>"
       << "</di_genHarvLogCutProbB>"
       << "<di_genHarvLogCutProbC>"
       << "<di_ghlcpcVal species=\"Species_1\">1.386188</di_ghlcpcVal>"
       << "<di_ghlcpcVal species=\"Species_2\">1.386188</di_ghlcpcVal>"
       << "</di_genHarvLogCutProbC>"
       << "<di_genHarvUseBiomassOrBA>1</di_genHarvUseBiomassOrBA>"
...
const char* WriteGeneralizedHarvestRegimeXMLFile5() {
  ...
  oOut << "<GeneralizedHarvestRegime1>"
       ...
       << "</di_genHarvLogCutProbMu>"
       << "<di_genHarvLogCutProbA>"
       << "<di_ghlcpaaVal species=\"Species_1\">100000</di_ghlcpaaVal>"
       << "<di_ghlcpaaVal species=\"Species_2\">100000</di_ghlcpaaVal>"
       << "</di_genHarvLogCutProbA>"
       << "<di_genHarvLogCutProbB>"
       << "<di_ghlcpbVal species=\"Species_1\">1</di_ghlcpbVal>"
       << "<di_ghlcpbVal species=\"Species_2\">1</di_ghlcpbVal>"
       << "</di_genHarvLogCutProbB>"
       << "<di_genHarvLogCutProbC>"
       << "<di_ghlcpcVal species=\"Species_1\">1</di_ghlcpcVal>"
       << "<di_ghlcpcVal species=\"Species_2\">1</di_ghlcpcVal>"
       << "</di_genHarvLogCutProbC>"
       << "<di_genHarvUseBiomassOrBA>0</di_genHarvUseBiomassOrBA>"
       << "<di_genHarvDoSaplingMort>1</di_genHarvDoSaplingMort>"
       << "<di_genHarvSapMortP>0.2</di_genHarvSapMortP>"
