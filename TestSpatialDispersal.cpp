...
// seed grid examined.
/////////////////////////////////////////////////////////////////////////////
TEST(SpatialDispersal, TestDispersal3) {
  clSimManager * p_oSimManager = new clSimManager( 7, 1, "" );
  try {
   clGrid *p_oSeedGrid;

   //Feed our file to the sim manager
   p_oSimManager->ReadFile(WriteSpatialDispersalXMLFile3());
...
const char* WriteSpatialDispersalXMLFile3()
{
  ...
  oOut << "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\" ?>"
       ...
       << "<di_weibullCanopyBeta>"
       << "<di_wcbVal species=\"Species_1\">2.0</di_wcbVal>"
       << "<di_wcbVal species=\"Species_2\">2.1</di_wcbVal>"
       << "<di_wcbVal species=\"Species_3\">2.2</di_wcbVal>"
       << "</di_weibullCanopyBeta>"
       << "<di_weibullCanopyDispersal>"
       << "<di_wcdVal species=\"Species_1\">1.76E-4</di_wcdVal>"
       ...
       << "</di_weibullGapTheta>"
       << "<di_weibullCanopySTR>"
       << "<di_wcsVal species=\"Species_4\">6.628</di_wcsVal>"
       << "<di_wcsVal species=\"Species_5\">17.206</di_wcsVal>"
       << "</di_weibullCanopySTR>"
       << "<di_weibullCanopyBeta>"
       << "<di_wcbVal species=\"Species_4\">2.3</di_wcbVal>"
       << "<di_wcbVal species=\"Species_5\">2.4</di_wcbVal>"
       << "</di_weibullCanopyBeta>"
       << "<di_lognormalCanopyX0>"
       << "<di_lcx0Val species=\"Species_4\">1.32E-4</di_lcx0Val>"
       << "<di_lcx0Val species=\"Species_5\">6.93E-6</di_lcx0Val>"
